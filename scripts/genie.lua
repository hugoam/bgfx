...
if _OPTIONS["with-glfw"] then
	GLFW_DIR = path.join(path.getabsolute("../.."), "two/3rdparty/glfw")
	project "glfw3"
		kind "StaticLib"
...
--	end
	...
	addWebAssets("example-21-deferred",
		{
			"vs_deferred_geom",     --"fs_deferred_geom_depthpacked",
			"vs_deferred_light",    --"fs_deferred_light_depthpacked",
	...
	project "example-40-svt"
		removelinkoptions { "-s TOTAL_MEMORY=256MB" }
		linkoptions       { "-s TOTAL_MEMORY=1024MB" }
