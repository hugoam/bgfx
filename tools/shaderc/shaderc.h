...
#define BGFX_UNIFORM_PUSHCONSTANTBIT UINT8_C(0x80)
#define BGFX_UNIFORM_MASK (BGFX_UNIFORM_FRAGMENTBIT|BGFX_UNIFORM_SAMPLERBIT|BGFX_UNIFORM_PUSHCONSTANTBIT)
